!function (e) {
    var t = {trigger: "imageMouseMove", triggerTarget: false, mouseMoveTrigger: 50, hoverTrigger: 200, scrollTrigger: 100, target: "> img"};
    e.fn.shuffleImages = function (n) {
        return this.each(function () {
            var r = e.extend({}, t, n), i = e(this), s = 0, o = r.mouseMoveTrigger, u = r.hoverTrigger, a = r.scrollTrigger, f = r.triggerTarget;
            i.addClass("si-container").find(r.target).css({maxWidth: "100%"}).not(":first-child").hide();
            ...
            switch (r.trigger) {
                ...
                case"documentMouseMove":
                    ...
                    break;
                case"documentScroll":
                    e(document).on("touchmove mousewheel DOMMouseScroll", function (t, n) {

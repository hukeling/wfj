						...
						<div class="TabParent_lj publicBorder ClearBoth">
							<div>
								<div class="radius publicPadding20 width90 margin-center BackgroundF8Hui publicMarginBot15" id="addressSwitchDiv">
									<form id="form1"  action="${pageContext.request.contextPath}/phone/edit.action" method="post">
										<input type="hidden" value="${customerAcceptAddress.customerAcceptAddressId}" id="dcustomerAcceptAddressId" name="customerAcceptAddress.customerAcceptAddressId" a="b" />
										<input type="hidden" id="customerId" name="customerAcceptAddress.customerId" value="${customerAcceptAddress.customerId}">
										<p class="strong">详细地址:</p>
										<p>
											<input value="${customerAcceptAddress.address}" style="line-height: 25px;" id="saveAddress" name="customerAcceptAddress.address" type="text" class="atext {validate:{required:true,maxlength:[150]}}">
										</p>
										<p class="strong">
											姓名:
										</p>
										<p>
											<input value="${customerAcceptAddress.consignee}" style="line-height: 25px;" id="dconsignee" name="customerAcceptAddress.consignee"
										...
										<p>
											<input value="${customerAcceptAddress.mobilePhone}" style="line-height: 25px;" id="dmobilePhone"

...
<!-- 	店铺主题====================start==================== -->
<div class="margin-center PublicWidth1004" style="height:380px;" >
<!--mainClass-->
  <div class="main_content">
<!--     店铺大图 -->
<!--    		右侧展示店铺名称 -->
     <div style="height:auto;width:1210px;padding:10px 0px 0px 0px;">
	   	<div  style="height:350px;width:350px;float: left;">
	  	...
	  	<div style="width:850px; height:350px; float: left; margin-left: 10px; display: inline;">
...
<!--          店铺简介 -->
            <div style="width: 850px; height:256px;">
	          <div  style="height: 256px;font-size:14px;line-height:28px;width:720px; margin-top:10px;background:none;word-wrap:break-word;overflow:hidden; float: left;">
	         	 ${shopInfo.synopsis}
			  </div>
			  <!-- 微信二维码begin -->
 			<img style=" width:112px; height:112px; float:right; display: inline-block;" src="<s:property value='%{#application.fileUrlConfig.visitFileUploadRoot}'/><s:property value='shopInfo.qrCode'/>" />
 			<!-- 微信二维码end -->
...
<div class="margin-center PublicWidth1004">
	  ...
	  <h3 style="color:#d01743; padding:10px; font-size: 15px; margin-top:15px; border-bottom: 3px solid #0086DD;">分类</h3><!-- 左侧列表 -->
		...
		<s:if test="qqList!=null">
		 ...
		 <!-- QQ客服end -->
				<!-- 推荐品牌 -->
 				<h3 style="color:#d01743; padding:10px; font-size: 15px; margin-top:15px; border-bottom: 3px solid #0086DD;">推荐品牌</h3> 
				...
				<s:if  test="brandList.size>0">
				 ...
				 <li>
					<a href="${pageContext.request.contextPath}/frontSearchProduct/productInfoSearch.action?pager.keyword=<s:property value='#brand.brandName'/>;">
					   <img style="height:100px; width:200px;" class="lazy" src="${fileUrlConfig.visitFileUploadRoot}<s:property value='logoImg'/>"  data-original="<s:property value='%{#application.fileUrlConfig.visitFileUploadRoot}'/><s:property value="#brand.brandBigImageUrl"/>" /></a>
				 </li>
				 </s:iterator>
				 </ul>
				</s:if>
					...
					<s:iterator value="productInfoList" var="productInfo" status="s">
							...
							<li style="height:303px;margin:0 7px 0 8px;"><a target="_blank"  style="display:block;width:220px;height:220px;" href="${pageContext.request.contextPath}/productInfo/<s:property value="#productInfo.productId" />.html">
								...
								<p style="height: 38px;overflow: hidden; margin-top:7px;">
									<a target="_blank" title="<s:property value="#productInfo.productFullName"/>" href="${pageContext.request.contextPath}/productInfo/<s:property value='#productInfo.productId'/>.html"><s:property value="#productInfo.productName" /></a>
								</p>
								<%-- <p class="ColorRed">

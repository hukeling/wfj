...
<body>
	...
	<div class="margin-center PublicWidth1004">
	  ...
	  <h3 class="publicPadding10 ColorRed publicBorderB_3red FontSize15">分类</h3><!-- 左侧列表 -->
	 	<span class="FontSize13 FontSizeB publicblock " style="color:#d01743;  padding:10px 0 0 5px;" >&nbsp;所有分类</span>
	       <div class="FontSize13 FontSizeB publicblock">
				...
				<div class="sortBy publicMarginBot15 publicMarginTop15">
					...
					<form id="form1xxx" name="form1" method="post" action="${pageContext.request.contextPath}/frontSearchProduct/productInfoSearch.action" >
			...
			<aside>
				<div class="FontSize13 gradient publicBorder publicPadding10 publicMarginBot15 produstsList_screen ClearBoth">
					...
					<a onclick="viewTypeSearch('tableType')" href="javascript:;" class="change_list_select ColorRed">列表</a> 
					<a onclick="viewTypeSearch('pictureSearch')" href="javascript:;" class="change_Gallery">图片</a> 
				</div>
			</aside>
              <!-- 查询的条件显示 -->
				...
				<ul class="account_MyCart">
					<s:iterator value="productInfoList" var="productInfo">
						...
						<img title="<s:property value="#productInfo.productFullName"/>" width="100px;" height="100px;"
							class="lazy" src="${fileUrlConfig.visitFileUploadRoot}<s:property value='logoImg'/>" data-original="<s:property value='%{#application.fileUrlConfig.visitFileUploadRoot}'/><s:property value="#productInfo.logoImg"/>" /></a>
						<div >
							<p style="height: 20px; overflow: hidden;">
								<a target="_blank" title="<s:property value="#productInfo.productFullName"/>" href="${pageContext.request.contextPath}/productInfo/<s:property value='#productInfo.productId'/>" class="FontSize13 FontSizeB"><s:property escape="false" value="#productInfo.productFullName" /></a>
							</p>							

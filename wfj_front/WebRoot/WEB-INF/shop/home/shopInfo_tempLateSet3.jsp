...
<script type="text/javascript">
    ...
    $(function(){
    	...
    	if(shopProCategoryId!=""){//选中内部分类
    		$("#shop_"+shopProCategoryId).attr("style","background-color: #BA0000;");
    	}else{//选中店铺首页
    		$("#shop_home").attr("style","background-color: #BA0000;");
    	}
...
<style type="text/css" >
	.moban_dh{height: 35px;width: 100%;background-color: red;}
	.moban_dh ul{height: 35px;width:1210px; margin:0 auto;}
	.moban_dh ul li{width:82px; height:35px; line-height:35px; float:left; text-align: center; font-size: 16px;}
	.moban_dh ul li a{color:#fff; text-decoration: none;}
	.moban_dh ul li:hover{background-color: #ba0000;}
</style>
...
<body>
	...
	<div class="moban_dh">
	   <ul >
			<li id="shop_home"><a href="${pageContext.request.contextPath}/store/frontShopMainPage/gotoShopInfoPage.action?orderBy=normal&shopInfoId=<s:property value='shopInfoId'/>"  style=" color: white;">店铺首页</a></li>
			<!-- 此处循环遍历商品分类 -->
			<s:iterator value="productTypeList">
				<li id="shop_<s:property value='shopProCategoryId'/>"><a href="${pageContext.request.contextPath}/store/frontShopMainPage/gotoShopInfoPage.action?shopInfoId=<s:property value="shopInfoId"/>&shopProCategoryId=<s:property value="shopProCategoryId"/>&orderBy=<s:property value='orderBy'/>&brandParams=<s:property  value='brandParams'/>&minPrice=<s:property value='minPrice'/>&maxPrice=<s:property value='maxPrice'/>"  style=" color: white;"><s:property value="shopProCategoryName"/></a></li>
			</s:iterator>
		</ul>
	</div>
	<div class="clear"></div>
...
<!-- 	        <a  style="color:#fff;" href="${pageContext.request.contextPath}/store/frontShopMainPage/gotoShopInfoPage.action?orderBy=normal&shopInfoId=<s:property value='shopInfoId'/>">${shopInfo.shopName }</a> -->
         ...
         <div class="modal" id="edit-payway-overlay" style="width: 300px;height: 100px;">
			...
			<p class="modal-buttons" style="margin-left: 60px;margin-top: 20px;">
	         ...
	         <div  style="float:right;">
	             ...
	             <div style="width: 94px;">&nbsp;&nbsp;<a style="color:#ccc;" href="javascript:favoriteShops();">收藏店铺</a>&nbsp;&nbsp;</div>
	         </div>   
	  		<div class="xiaobiao">
		<!-- 店铺等级 -->
	            	<div class="yuan">
	               	...
	               	<s:else>
	               		<div class="feed"  style="color:#ccc;"><span class="jiuwu">0%</span>&nbsp;信誉</div>
	               		<span style="font-family:Calisto MT;font-size:14px;font-weight:normal;font-style:normal;text-decoration:none;color:#ccc">店主：${shopInfo.customerName}</span>
	               	</s:else>
	          </div>
	<!--          店铺简介 -->
		          <div  style="height: 112px;font-size:14px;line-height:28px;width:1080px; margin-top:10px;background:none;word-wrap:break-word;overflow:hidden; color:#fff;">
		          ${shopInfo.synopsis}
				  </div>
				<div style="width:112px; height:112px; float:right;">
           		<!-- 微信二维码begin -->
				<img style="width:112px; height:112px; position: relative; top:-110px;" src="<s:property value='%{#application.fileUrlConfig.visitFileUploadRoot}'/><s:property value='shopInfo.qrCode'/>" />
				<!-- 微信二维码end --> 	
				</div>
	...
	<div class="margin-center PublicWidth1004">
		<div class="ClearBoth">
			...
			<!--right-->
			<div id="rightBox" class="float-right publicHidden" style="width:1210px;">
			<aside><!-- 排序 -->
              ...
              <s:if test="mapParams.size>0">
				...
				<ul class="WishListUl ClearBoth">
					...
					<s:iterator value="productInfoList" var="productInfo" status="s">
							<li style="height:303px;margin:0 9px 0 8px;"><a target="_blank"  style="display:block;width:220px;height:220px;" href="${pageContext.request.contextPath}/productInfo/<s:property value="#productInfo.productId" />.html">
	...
	<div style="width:1208px; margin:0 auto;">
		...
		<div class=" publicPaddingLR10" >
			<s:if  test="brandList.size>0">
				 <ul style="padding-top:25px; height:130px;">
				 	<s:iterator value="brandList" var="brand">
				     <li style="width:200px; height:100px; float:left; margin:0 8px; padding:10px 10px;">
					   <a href="${pageContext.request.contextPath}/frontSearchProduct/productInfoSearch.action?pager.keyword=<s:property value='#brand.brandName'/>;">

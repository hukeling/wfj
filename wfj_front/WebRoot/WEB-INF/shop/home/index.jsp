...
<!-- 新版轮播图js开始 -->	
<script type="text/javascript" src="${fileUrlConfig.fileServiceUploadRoot}shop/homeIndex/js/tt.index_V1.4.min-t.js"></script>
<!-- 新版轮播图js结束 -->		
<script type="text/javascript" src="${fileUrlConfig.fileServiceUploadRoot}shop/front/js/jquery.lazyload.min.js"></script>
<script type="text/javascript" src="${fileUrlConfig.fileServiceUploadRoot}shop/homeIndex/js/tab.js"></script>
...
<!-- 轮播图下方的滚动图片 -->
<script type="text/javascript" src="${fileUrlConfig.fileServiceUploadRoot}shop/homeIndex/js/scroll.1.3.js"></script>
<style type="text/css">
	body{font-family:微软雅黑;}
	.z_index_focus {z-index: -1;}
	.banner_bg {width:790px; height:251px; /*position: relative;*/ overflow: hidden;}
	.banner_marquee {height:251px; overflow: hidden; z-index: 0; min-width: 990px;}
	.banner_marquee_list {margin: 0px auto; width:790px; height:251px;  overflow: hidden;}
	.banner_marquee_list li {width:790px; height:251px;  overflow: hidden;}

	.banner_main {margin: 0px auto; width:790px; height:251px;  overflow: hidden;}
	.banner_marquee_list li a.banner_link {width: 790px; height: 251px; margin-left: 190px; display: block;}
	.banner_btn {/*left: 50%;*/ width:790px; height: 25px; text-align: right; /*bottom: 12px; */overflow: hidden; position: absolute; z-index:5; top:402px;}
	.banner_btn span {width: 25px; height: 25px; text-align: center; color: rgb(136, 136, 136); line-height: 25px; font-family: Verdana, Geneva, sans-serif; font-size: 35px; display: inline-block; cursor: pointer; _display: inline; _zoom: 1;}
	.banner_btn span.on {color: rgb(236, 26, 91);}
	...
	*+html .clearfix{min-height:1%}
	...
	.wc960{width:790px; margin-top:10px; border:1px solid #CCC;}
	.fl{float:left;}
	.fr{float:right;}
	
	.icon{background:url(${fileUrlConfig.fileServiceUploadRoot}shop/homeIndex/img/icon.png) no-repeat 0 0;}
	...
	/*热门车型*/
	.rowE .warp-pic-list{width:739px;height:110px;overflow:hidden;/* margin-left:10px; */}
	.rowE .count li{ width:147px;height:110px; display:inline-block; border-right:1px solid  #CCC; }
	.rowE .count li:last-child{ border-right:none;}
	.rowE .count li img{width:147px;height:110px;display:inline-block;}
	.rowE .count .img_wrap{width:147px;height:110px;}
	...
	.rowE .btn{display:block;height:110px;position:absolute;top:0px;width:26px;z-index:200;cursor:pointer;}
	.rowE .prev{ background-position:0 -1px;left:0;}
	.rowE .prev:hover{background-position:0 -112px;}
	.rowE .next{ background-position:0 -222px;right:-8px;}
	.rowE .next:hover{background-position:0 -333px;}
	/* 购物车css */
						...
						<span>
							<font color="red">
								...
								<s:if test="#session.sonaccount!=null">
									...
									<s:if test="#session.sonaccount.type==3">
										普通用户
									</s:if>
...
<!-- 	标准log大小	style="width: 259px;height:49px;" -->
		...
		<!-- 热线电话 -->
        <div style="float:right; width:166px; height:31px; line-height:31px; padding-top:13px; color:#333; font-size:16px; font-weight:bold; text-align: right; padding-right:6px;">
		...
		<div class="header_navContent">
			...
			<div class="primaryNav fl">
				<p class="rig_gx" style="">
					<a href="${pageContext.request.contextPath}/" style="background-color: #e62d59;">首页</a>
				</p>
				<p class="rig_gx">  
					<a
				...
				<p class="rig_gx">
					<a  href="${pageContext.request.contextPath}/homeModule/dayRecommend.action?headerType=dayRecommend">SHOPJSP热销</a>
				</p>
				...
				<a id="home_industrySpecific" class="header_Selected" href="${pageContext.request.contextPath}/front/quickOrder/quickOrder.action">极速热购</a>
				<p class="rig_gx" >
					<a id="home_coupon" href="${pageContext.request.contextPath}/front/discountcoupon/coupon/gotofrontcoupon.action?headerType=coupon">优惠券</a>
				</p>
				<p class="rig_gx" >
					<a id="home_group" href="${pageContext.request.contextPath}/tuan/gotoTuanHome.action?headerType=group">团购</a>
				</p>
			</div>
               <!-- 改变之后的购物车 -->
	...
	<div class="wrapper">
		...
		<div class="wc960 row rowE">
			...
			<div class="bd" style="margin-top:0;position:relative;padding:0 25px;">
					...
					<div id="wrapBox1" class="wrapBox" style="width:741px;">
						<ul id="count1" class="count clearfix">
							<s:iterator value="#request.homeLittleAdvertisementList">
								<li>
									<a style="padding:0;" target="_blank" href="${link}" class="img_wrap"><img src="${fileUrlConfig.visitFileUploadRoot}${imageUrl}" width="147" height="90" border="0"></a>
								</li>
							</s:iterator>
							
						</ul>
					</div>
					<a id="right1" href="javascript:;" class="prev icon btn" style="cursor: pointer; width:25px !important;left:0;"></a>
					<a id="left1" href="javascript:;" class="next icon btn" style="cursor: pointer;width:25px !important;right:0;"></a>
				</div>
			</div>
		</div>
		<!--infopic end-->
		...
		<div class="expressPart fl">
			...
			<!--天天快报-->
			<div class="dailyExpress" style="margin:0;height:auto; margin-top:5px;">
				<span>SHOPJSP快报<s:if test="#request.articleList.size>0"><a href="${pageContext.request.contextPath}/shopHome/moreNews.action" style="color:#fff; padding-left:92px; font-size:12px; font-weight: normal;">更多></a></s:if>
				</span>
				<div class="dailyExpressC" style="height:134px;border-bottom: 1px solid #EEEEEE;">
						...
						<s:iterator value="#request.articleList" var="art" status="st">
							<s:if test="#st.index<5">
								<s:if test="#art.title.length()>15">
									<a title="<s:property value='#art.title'/>" href="${pageContext.request.contextPath}/helpFront/gotoHelpFrontList.action?articleId=<s:property value='#art.articleId'/>" target="_blank"><s:property value='#art.title.substring(0,15)'/></a>
								</s:if>
								<s:else>
									<a title="<s:property value='#art.title'/>" href="${pageContext.request.contextPath}/helpFront/gotoHelpFrontList.action?articleId=<s:property value='#art.articleId'/>" target="_blank"><s:property value='#art.title'/></a>
								</s:else>
							</s:if>	
						</s:iterator>
					</s:if>
			...
			<s:if test="#request.homeAdvertisementList.size>=2">
				<a href="<s:property value='#request.homeAdvertisementList[1].link'/>"
    ...
    <!--限时速购倒计时-->
  	<div class="instantaneousPurchase fl">
        <div class="instantaneousTitle" id="limitColumn_li_current_">
            <ul>
                 <s:iterator value="#application.homekeybook['countDownLocation']" var="hkb" status="u">
                 	<s:if test="#u.index==0">
  		...
  		<div class="instantaneousContent" id="limitColumn_1">
  			<s:if test="#request.homeParticularlyTabList1.size>0">
  				<s:iterator value="#request.homeParticularlyTabList1" var="hp1" status="u">
...
<%--                     <div class="priceMarking"><img src="${fileUrlConfig.fileServiceUploadRoot}shop/homeIndex/img/priceMarking.png"/></div>--%>
                     <a class="commodityPic" target="_blank" href="<s:property value='#hp1.link' />"><img class="lazy"  src="${fileUrlConfig.fileServiceUploadRoot}images/blank.gif" data-original="${fileUrlConfig.visitFileUploadRoot}<s:property value='#hp1.imageUrl' />" width="160" height="160"/></a>
                     <a href="<s:property value='#hp1.link' />" target="_blank"><s:property value='#hp1.synopsis' /></a><!--描述-->
                     <div class="priceYin">SHOPJSP价：<span>￥<s:property value='#hp1.price' /></span></div>
                 </div>
  				</s:iterator>
  			</s:if>
          </div>
  		<div id="limitColumn_2" class="instantaneousContent hide">
  			<s:if test="#request.homeParticularlyTabList2.size>0">
  				<s:iterator value="#request.homeParticularlyTabList2" var="hp2" status="u">
  				<div class="commodityYin">
<%--                    <div class="priceMarking"><img src="${fileUrlConfig.fileServiceUploadRoot}shop/homeIndex/img/priceMarking.png"/></div>--%>
                    <a class="commodityPic" target="_blank" href="<s:property value='#hp2.link' />"><img class="lazy"  src="${fileUrlConfig.fileServiceUploadRoot}images/blank.gif" data-original="${fileUrlConfig.visitFileUploadRoot}<s:property value='#hp2.imageUrl' />" width="160" height="160"/></a>
                    <a href="<s:property value='#hp2.link' />" target="_blank"><s:property value='#hp2.synopsis' /></a>
                    <div class="priceYin">SHOPJSP价：<span>￥<s:property value='#hp2.price' /></span></div>
                </div>
  				</s:iterator>
  			</s:if>
        </div>
  		<div id="limitColumn_3" class="instantaneousContent hide">
  			<s:if test="#request.homeParticularlyTabList3.size>0">
  				<s:iterator value="#request.homeParticularlyTabList3" var="hp3" status="u">
  					<div class="commodityYin">
<%--                    <div class="priceMarking"><img src="${fileUrlConfig.fileServiceUploadRoot}shop/homeIndex/img/priceMarking.png"/></div>--%>
                    <a class="commodityPic" target="_blank" href="<s:property value='#hp3.link' />"><img class="lazy"  src="${fileUrlConfig.fileServiceUploadRoot}images/blank.gif" data-original="${fileUrlConfig.visitFileUploadRoot}<s:property value='#hp3.imageUrl' />" width="160" height="160"/></a>
                    <a href="<s:property value='#hp3.link' />" target="_blank"><s:property value='#hp3.synopsis' /></a>
                    <div class="priceYin">SHOPJSP价：<span>￥<s:property value='#hp3.price' /></span></div>
                </div>
  				</s:iterator>
  			</s:if>
          </div>
  		<div id="limitColumn_4" class="instantaneousContent hide">
  			<s:if test="#request.homeParticularlyTabList4.size>0">
  				<s:iterator value="#request.homeParticularlyTabList4" var="hp4" status="u">
  					<div class="commodityYin">
<%--                    <div class="priceMarking"><img src="${fileUrlConfig.fileServiceUploadRoot}shop/homeIndex/img/priceMarking.png"/></div>--%>
                    <a class="commodityPic" target="_blank" href="<s:property value='#hp4.link' />"><img class="lazy"  src="${fileUrlConfig.fileServiceUploadRoot}images/blank.gif" data-original="${fileUrlConfig.visitFileUploadRoot}<s:property value='#hp4.imageUrl' />" width="160" height="160"/></a>
                    <a href="<s:property value='#hp4.link' />" target="_blank"><s:property value='#hp4.synopsis' /></a>
                    <div class="priceYin">SHOPJSP价：<span>￥<s:property value='#hp4.price' /></span></div>
                </div>
  				</s:iterator>
  			</s:if>
          </div>
  		<div id="limitColumn_5" class="instantaneousContent hide">
  			<s:if test="#request.homeParticularlyTabList5.size>0">
  				<s:iterator value="#request.homeParticularlyTabList5" var="hp5" status="u">
  					<div class="commodityYin">
<%--                    <div class="priceMarking"><img src="${fileUrlConfig.fileServiceUploadRoot}shop/homeIndex/img/priceMarking.png"/></div>--%>
                    <a class="commodityPic" target="_blank" href="<s:property value='#hp5.link' />"><img class="lazy"  src="${fileUrlConfig.fileServiceUploadRoot}images/blank.gif" data-original="${fileUrlConfig.visitFileUploadRoot}<s:property value='#hp5.imageUrl' />" width="160" height="160"/></a>
                    <a href="<s:property value='#hp5.link' />" target="_blank"><s:property value='#hp5.synopsis' /></a>
                    <div class="priceYin">SHOPJSP价：<span>￥<s:property value='#hp5.price' /></span></div>
                </div>
  				</s:iterator>
  			</s:if>
          </div>
						...
						<s:if test="#m.promotionProductList!=null">
						    <div class="ificationPic">
								<s:iterator value="#m.promotionProductList" var="ppl">
									<a target="_blank" href="<s:property value='#ppl.link' />" style="text-decoration: none;">
										<img width="80px" height="35px" class="lazy"
						...
						<s:if test="#u.index==0">
							<li class="item e-childload on" onmouseover="openThis(this)">
								...
								title="<s:property value="#sortProduct.title"/>"><img
									...
									original="img/9275106_60x98.jpg" 
									width="60" height="98" border="0" alt="" /></a> <a
								href="<s:property value="#sortProduct.link"/>" target="_blank"
								class="prod-name"

...
<title>优惠券</title>
<link href="${fileUrlConfig.fileServiceUploadRoot}shop/front/css/cart.css" type="text/css" rel="stylesheet"></link>
<link href="${fileUrlConfig.fileServiceUploadRoot}shop/front/css/product_search.css" type="text/css" rel="stylesheet"></link>
<link href="${fileUrlConfig.fileServiceUploadRoot}shop/front/css/youhuijuan_channel.css" type="text/css" rel="stylesheet"></link>
...
<!--mainClass-->
  <div class="main_content">
    ...
    <div class="gate_hold">
       <div class="gate_head">
         <div class="gatewenzi"><s:property value="shopCategory.shopCategoryName" /></div>
       </div>
       	<div class="shopimg">
         ...
         <div class="shopim_left">
           ...
           <div class="cdoff">
             ...
             <div class="cd_right">
               ...
               <br><span style="font-size:13px;color:#999999;">有效日期至 <s:date name="expirationTime" format="yyyy-MM-dd" /></span></div>

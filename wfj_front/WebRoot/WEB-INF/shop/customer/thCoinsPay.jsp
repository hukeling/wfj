            ...
            <ol>
				...
				<div id="body" style="clear: left">
					<dl class="content" style="display: none">
						<input name="WIDseller_notify_url" type="hidden" value="<s:property value="#application.keybook['buyTHCoinsAJAXURL'][0].value"/>"/>
						<input name="WIDseller_return_url" type="hidden" value="<s:property value="#application.keybook['buyTHCoinsGETURL'][0].value"/>"/>
						<dt>
							卖家支付宝帐户：
						</dt>
						<dd >
						...
						<dd>
							<span class="null-star">*</span>
							<input size="30" name="WIDout_trade_no" value="${virtualCoinNumber}"/>
						...
						<dd>
							<span class="null-star">*</span>
							<input size="30" name="WIDreceive_name" value=""/>
							<span>如：张三 </span>
						</dd>
						<dt>
							收货人地址：
						...
						<dd >
							<span class="null-star">*</span>
							<input size="30" name="WIDreceive_address" value=""/>
						...
						<dd>
							<span class="null-star">*</span>
							<input size="30" name="WIDreceive_zip"  value=""/>
							<span>如：123456 </span>
						</dd>
						<dt>
							收货人电话号码：
						...
						<dd>
							<span class="null-star">*</span>
							<input size="30" name="WIDreceive_phone" value=""/>
						...
						<dd>
							<span class="null-star">*</span>
							<input size="30" name="WIDreceive_mobile" value=""/>

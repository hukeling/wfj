...
.alipay_link a:visited {
	...
	<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
        ...
        <div class="cashier-nav">
			...
			<form id="alipayment" name="alipayment" action="${pageContext.request.contextPath}/front/customer/shoppingOnline/alipayapi.action" method="post" target="_blank">
				...
				<div id="body" style="clear: left">
					<dl class="content" style="display: none">
						...
						<dd>
							<span class="null-star">*</span>
							<input size="30" name="WIDout_trade_no" value="${orders.totalOrdersNo}"/>
						...
						<dd>
							<span class="null-star">*</span>
							<input size="30" name="WIDprice" value="${orders.finalAmount}"/>
							<span>必填 </span>
						</dd>
						<dt>
							订单描述 ：
						...
						<dd>
							<span class="null-star">*</span>
							<input size="30" name="WIDbody" value="${orders.ordersNo}"/>
							<span></span>
						</dd>
						<dt>
							商品展示地址：
						...
						<dd>
							<span class="null-star">*</span>
							<input size="30" name="WIDreceive_name" value="${orders.consignee}"/>
							<span>如：张三 </span>
						</dd>
						<dt>
							收货人地址：
						...
						<dd >
							<span class="null-star">*</span>
							<input size="30" name="WIDreceive_address" value="${orders.address}"/>
						...
						<dd>
							<span class="null-star">*</span>
							<input size="30" name="WIDreceive_zip"  value="${orders.postcode}"/>
							<span>如：123456 </span>
						</dd>
						<dt>
							收货人电话号码：
						...
						<dd>
							<span class="null-star">*</span>
							<input size="30" name="WIDreceive_phone" value="${orders.phone}"/>
						...
						<dd>
							<span class="null-star">*</span>
							<input size="30" name="WIDreceive_mobile" value="${orders.mobilePhone}"/>

  ...
  <!--   <div class="maincon_right" >
     ...
     <div class="ClearBoth" style=" padding-left:10px;">
       <div class="serchtex" style="float:left; width:350px; height:25px;  line-height:25px;border:1px #7f9db9 solid;">
			<input onkeydown="submitSearch(event)" id="str" name="str" type="text" class="texxx" style="width:330px;height:24px; line-height:25px; border:0; color:#999; padding-left: 5px;"/>
       </div>
       <div class="suosouan" style="width:89px; height:26px; float:left; margin-left:16px; display:inline;">
	       <a style="text-decoration: none;" onclick="getHelpList();" >
	       	<input type="button" value="搜索" class="BackgroundRed ColorWhite1 publicNoBorder FontSize14" style="width:89px;height:26px; "/>
	       </a>
       </div>
     </div>
    </div>   -->
...
<!--          	<h3 class="sd" style="margin-bottom:15px;">关键字 &quot;<font style="color: red;"><s:property value="str" /></font>&quot;</h3> -->
         	<ul>
         		<s:iterator value="articleList" id="s">

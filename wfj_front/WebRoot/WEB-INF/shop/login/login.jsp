...
<style type="text/css">
	a#usePhoneLoginA:hover,a#useNameLoginA:hover,a#fsyzm:hover{ font-size:13px; text-decoration:underline; color:#d01743!important;}
</style>
</head>
   ...
   <div class="hesder_topCode">
       <!--top-->
          ...
          <div class="welcomeYin fr">
                <a style="margin-left:0; padding:0 7px 0 3px;" class="fr"href="${pageContext.request.contextPath}/helpFront/gotoHelpFront.action">
...
<h3 class=" publicPadding20 FontSize20 FontSizeB">普通用户登录 | <span style="color:blue; font-size:14px;"><a style="color:blue" href="${pageContext.request.contextPath}/loginCustomer/gotoLoginPage.action?type=2">供应商登录</a></span></h3>
...
<p style="text-align:left;">
<input type="button" id="loginButtion" style="width: 200px; cursor: pointer; border:0;" onclick="dengluUseNameOrPhone(1)" isTrue="1"  value="登录"  class="submitButtonL BackgroundRed publicinline publicPadding5_10 FontSize16 radius strong"/>
</p>
</div>
</div>
...
<div class="login_left_h">
<h3 class=" publicPadding20 FontSize20 FontSizeB">普通用户登录 </h3>
<div class="publicPadding10" style="padding-left:65px;">
<p class="publicrelative">
...
<div class="login_right_h" style="height:auto; right:42px; width:auto;">
...
<div style="width:140px; height:30px; line-height:24px;  background:#7CBE56; text-align: center; float:right; margin-right:50px;border-bottom:6px #e8e8e8 solid; border-left:6px #e8e8e8 solid; border-right:6px #e8e8e8 solid;"><a href="${pageContext.request.contextPath}/register/gotoCustomerRegistrationPage.action?type=3 " style=" color:#fff; font-size:14px;  cursor:pointer;">免费注册>></a></div>

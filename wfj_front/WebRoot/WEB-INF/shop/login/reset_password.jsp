...
$(function() {//表单验证
	$("#form1").validate({meta: "validate", 
		submitHandler:function(form){
			...
			var url ="${pageContext.request.contextPath}/loginCustomer/reSetPasswordValidate.action";
			$.post(url,{password:$("#password2").val(),passwordRandomCode:passwordRandomCode},function(data){
				   if(data==null||data.isSuccess=="F"){
					   $("#subitButton").attr("disabled",false);
					   $(".loginPasswordMessage").html("重置密码链接失效!");
					  return false;
				   }else{
					  window.location.href="${pageContext.request.contextPath}/loginCustomer/reSetPasswordOk.action";
				   }
			},"JSON");
		}
	});
...
<body>
	...
	<input id="passwordRandomCode" type="hidden" value="<s:property value='#request.passwordRandomCode'/>"/>
		<div class="w600BoxBody">
			<div class="boxTitle">重置密码333</div>

	...
	<head>
		...
		<script type="text/javascript">
			...
			jQuery.validator.addMethod("checkYHKMax", function(value, element) {
				...
				var max='<s:property value="#request.gysSCBMAX"/>';
	...
	<body>
		...
		<div class="margin-center PublicWidth1004">
			<div class="ClearBoth">
				...
				<h3 class="publicBorderB_3red FontSize16 FontSizeB publicPadding10 publicMarginBot15 ">供应商商城币提现</h3>
				<fieldset class="publicNoBorder">
							<form id="form1" name="form1" action="${pageContext.request.contextPath}/front/store/supplierMallCoin/saveSupplierMallCoinDetailInfo.action" method="post">
								...
								<ul class="strong">
									...
									<li class="ClearTitile" style="height:24; line-height:24px;">提醒：当前供应商商城币提现比例为<font color="red"><s:property value='#request.gysSCBtxBL'/>:1</font></li>
									<li class="ClearTitile" style="height:24; line-height:24px;">当前可用供应商商城币数量：<font color="red">
											<s:property value='#request.gysSCBMAX'/>
									  </font>
									</li>
									...
									<table>
										<tr style="width: 600px;">
											...
											<td align="left"><input id="cardHolder" name="shopMallCoinWithdrawals.cardHolder" value="" type="text" class="widthpx190 height25_h {validate:{required:true,maxlength:[25]}}"></td>
										</tr>
										<tr style="width: 600px;">
											<td align="right"><span style="text-align:right" ><i class="ColorRed">*</i>&nbsp;&nbsp;卡号:</span></td>
											<td align="left"><input id="cardNumber" name="shopMallCoinWithdrawals.cardNumber" value="" type="text" class="widthpx190 height25_h {validate:{required:true,checkYHKNO:true}}"></td>
										</tr>
										<tr style="width: 600px;">
											<td align="right"><span style="text-align:right" ><i class="ColorRed">*</i>&nbsp;&nbsp;预留手机号:</span></td>
											<td align="left"><input id="phone" name="shopMallCoinWithdrawals.phone" value="" type="text" class="widthpx190 height25_h {validate:{required:true,mobile:true}}"></td>
										</tr>
										<tr style="width: 600px;">
											<td align="right"><span style="text-align:right" ><i class="ColorRed">*</i>&nbsp;&nbsp;提现供应商商城币数量:</span></td>
											<td align="left"><input id="transactionAmount" name="shopMallCoinWithdrawals.transactionAmount" value="" type="text" class="widthpx190 height25_h {validate:{required:true,digits:true,checkYHKMax:true,min:1}}"></td>
										</tr>
										<tr style="width: 600px;">
											<td align="right"><span style="text-align:right" >&nbsp;&nbsp;留言:</span></td>
											<td align="left"><textarea id="customerMessage" name="shopMallCoinWithdrawals.customerMessage" cols="50" rows="5" value="" class="{validate:{maxlength:[250]}}" style="border:1px #d3d3d3 solid;"></textarea></td>
										</tr>
									</table>
									<div>

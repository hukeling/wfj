	...
	<body>
		...
		<div id="overly_div" class="margin-center PublicWidth1004">
			<div class="ClearBoth" style="margin-top:10px;">
				...
				<h3 class="publicBorderB_3red FontSize16 FontSizeB publicPadding10 publicMarginBot15 ">供应商商城币收支明细</h3>
				<form id="formModule" action="${pageContext.request.contextPath}/front/store/supplierMallCoin/gotoShopSupplierMallCoinDetailListPage.action" method="post">
					...
					<aside class="accountOrder_search ClearBoth publicMarginBot15">
						...
						<div>
							<select id="qtype" name="type" style="height:22px; line-height: 22px; border:1px #ccc solid;">
					...
					<div class="TabParent_lj ClearBoth">
						<div class="publicMarginTop15">
							<table width="100%" border="0" class="RecentlyOrdersTable_lj">
								...
								<s:iterator value="supplierMallCoinDetailList" var="map">
									<tr>
										<td style="border-bottom: 1px #d2d2d2 solid;">
											<s:if test="#map.ordersNo!=null && #map.ordersNo!=''">
												<s:property value="#map.ordersNo" />
											</s:if>
											<s:else>无</s:else>
										</td>
										<td style="border-bottom: 1px #d2d2d2 solid;">
											<s:property value="#map.tradMallCoin" />
										</td>
										<td style="border-bottom: 1px #d2d2d2 solid;">
											<s:if test="#map.type == 1">收入</s:if>
											<s:elseif test="#map.type == 2">支出</s:elseif>
											<s:elseif test="#map.type == 3">提现</s:elseif>
										</td>
										<td style="border-bottom: 1px #d2d2d2 solid;">

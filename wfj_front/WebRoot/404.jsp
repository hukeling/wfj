...
<html>
  <head>
	...
	<link href="${fileUrlConfig.fileServiceUploadRoot}shop/front/css/public.css" rel="stylesheet"  type="text/css" />
	<link href="${fileUrlConfig.fileServiceUploadRoot}shop/front/css/index_1.css" rel="stylesheet"  type="text/css" />	
	<!-- 底部信息样式 -->
	<style>
		.foot{height:165px; background:#f7f7f7; overflow:hidden;text-align:center;}
  ...
  <body>
    <div class="margin-center PublicWidth1004">
		<img src="${fileUrlConfig.fileServiceUploadRoot}shop/front/images/error/404.png" class="publicblock margin-center publicMarginTop15 publicMarginBot15" >

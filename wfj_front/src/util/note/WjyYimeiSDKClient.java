...
public class WjyYimeiSDKClient {
	...
	public static void main(String[] args) {
		...
		//testRegistEx();
		//发送短信
		sendSMS("13520186024","555555");
		//testGetBalance();查询余额
		//sendSMS("15269142501","短信发送内容ab12");
		//sendSMS("15301399211","短信发送内容吃好的");
		//sendSMS("15210553844","短信发送内容去吃大餐");
		//sendSMS("15201333313","短信发送内容去吃大餐");
		//关闭连接
		System.exit(0);
	}
...
//		System.out.println(SingletonClient.getPassword());
		int i = SingletonClient.getClient().registEx(SingletonClient.getPassword());
...
//		System.out.println("*********");
		try {
			//int i=SingletonClient.getClient().sendSMS(new String[] {"15011158343"}, "即时短信","",5);//带扩展码
			Client client = SingletonClient.getClient();
			int i=client.sendSMS(new String[] {phone},"您正在登录天海微商城，验证码："+message+" ，为了您的账户安全，请勿将验证码告知他人。【天海微商城】",5);//带扩展码
//			System.out.println("手机号码:"+phone);
//			System.out.println("短信内容:"+"您正在登录天海微商城，验证码："+message+"，为了您的账户安全，请勿将验证码告知他人。【天海微商城】");
...
//			System.out.println("testRegistDetailInfo:" + a);
	...
	public static void testSerialPwdUpd() {
		try {
			int a = SingletonClient.getClient().serialPwdUpd(SingletonClient.getPassword(), "501683");

...
import util.newAlipay.sign.MD5;
import util.newAlipay.util.httpClient.HttpProtocolHandler;
import util.newAlipay.util.httpClient.HttpRequest;
import util.newAlipay.util.httpClient.HttpResponse;
import util.newAlipay.util.httpClient.HttpResultType;
/* *
 *类名：AlipaySubmit
 *功能：支付宝各接口请求提交类

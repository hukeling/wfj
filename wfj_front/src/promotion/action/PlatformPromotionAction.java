...
public class PlatformPromotionAction extends BaseAction {
	...
	public String gotoPlatformPromotionListPage(){
		...
		//所有的活动
		int totalRecordCount=platformPromotionService.getCount(" where o.isPass=2");
		pageHelper.setPageInfo(pageSize, totalRecordCount,currentPage);
		platformPromotionList=platformPromotionService.findListByPageHelper(null, pageHelper, " where o.isPass=2 order by o.createTime desc");
		return SUCCESS;
	}
	//店铺申请参加促销活动
	@SuppressWarnings("unchecked")
